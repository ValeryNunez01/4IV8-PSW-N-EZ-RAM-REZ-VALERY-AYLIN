...
public class Actualizar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<script src='./JS/update_2.js'></script>");
            out.println("<link rel='stylesheet' href='./CSS/diseño3.css'>"); 
            out.println("</head>");
            out.println("<body>");
            out.println("<form method='post' action='ActualizarUsuarios' onsubmit='return checar()'>");
            out.println("<h1>Tabla General de Usuarios</h1>");
            out.println("<table border='2' id='tabla'>"
                    + "<thead>"
                        +"<tr><th>Editar</th>"
                        +"<th>Nombre</th>"
                    ...
                    + "</thead>");
            out.println("<br>");
            out.println("<input type='submit' id='boton' value='Actualizar'>");
            out.println("<p id='salida'></p>");
            ...
            try{
                ...
                String q = "select * from mregistrodos";
                ...
                //mientras exista un registro hay que obtener los datos de la consulta
                    ...
                    out.println("<tbody>"
                            + "<tr><td><input type='radio' name='radioid' id='radio_"+id+"' value='"+id+"' onclick='activacampos(this)'></td>"                                    
                            + "<td><input type='text' id='nombre_usuario_"+id+"' name='nom_usuario' value='"+nom+"' disabled></td>"
                            + "<td><input  type='text' id='apellidop_usuario_"+id+"' name='appat_usuario' value='"+appat+"' disabled></td>"
                            + "<td><input type='text' id='apellidom_usuario_"+id+"' name='apmat_usuario' value='"+apmat+"' disabled></td>"
                            + "<td><input type='number' id='edad_usuario_"+id+"' name='edad_usuario' value='"+edad+"' disabled></td>"
                            + "<td><input type='text' id='correo_usuario_"+id+"' name='correo_usuario' value='"+correo+"' disabled></td></tr>"
                            + "</tbody>");
                ...
                System.out.println("Consulta Exitosa here");
                rs.close();
                set.close();
